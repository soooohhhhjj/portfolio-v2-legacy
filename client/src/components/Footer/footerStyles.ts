export const footerStyles = {
  ...
  groundTexture: "absolute inset-0 bg-[radial-gradient(circle_at_50%_0%,rgba(255,255,255,0.03),transparent_50%)] pointer-events-none",
  groundLines: "absolute top-0 left-0 right-0 h-[1px] bg-gradient-to-r from-transparent via-white/30 to-transparent",
  
  // Subtle grid like landing pad
  grid: "absolute inset-0 opacity-[0.02] pointer-events-none bg-[linear-gradient(rgba(255,255,255,0.1)_1px,transparent_1px),linear-gradient(90deg,rgba(255,255,255,0.1)_1px,transparent_1px)] bg-[size:50px_50px]",
  ...
  socialLink: "flex items-center gap-2 rounded-md border border-white/10 px-2.5 py-1.5 text-[11px] font-jura text-white/70 hover:text-white hover:border-white/25 hover:bg-white/5 transition-all duration-200",
  socialIcon: "h-3.5 w-3.5",
  
  divider: "my-6 h-px w-full bg-gradient-to-r from-transparent via-white/20 to-transparent",
  
  bottomRow: "flex flex-col gap-2 text-[11px] font-jura text-white/50 sm:flex-row sm:items-center sm:justify-between",
};